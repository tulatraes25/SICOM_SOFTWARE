-- =====================================================
-- SICOM QR Ascensores - Datos de Prueba Integrales
-- =====================================================
-- IMPORTANTE: Ejecutar solo después del esquema inicial
-- Estos datos son ficticios para pruebas
...
-- =====================================================
-- DESTINATARIOS (ejemplo para ASC-0001)
-- =====================================================
...
-- =====================================================
-- Los usuarios deben crearse desde Authentication > Users
-- Luego asignar roles:
...
-- =====================================================
-- USUARIOS DE PRUEBA RÁPIDOS (alternativa)
-- =====================================================
-- Si necesitas usuarios rápidos para testing, ejecuta esto después de crear los usuarios en Auth:

-- Asignar responsable a ASC-0001

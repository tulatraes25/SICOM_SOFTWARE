...
import TechVisitDetailPage from '@/pages/technician/TechVisitDetailPage';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/tecnico/visitas/:entryId" element={<ProtectedRoute allowedRoles={['technician', 'admin']}><TechVisitDetailPage /></ProtectedRoute>} />

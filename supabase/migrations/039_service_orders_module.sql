...
REVOKE ALL ON FUNCTION create_service_order(UUID,UUID,TEXT,TEXT,UUID,DATE,TIME,TEXT,TEXT,TEXT,TEXT,TEXT,UUID,UUID,UUID) FROM PUBLIC;
REVOKE ALL ON FUNCTION create_service_order(UUID,UUID,TEXT,TEXT,UUID,DATE,TIME,TEXT,TEXT,TEXT,TEXT,TEXT,UUID,UUID,UUID) FROM anon;
GRANT EXECUTE ON FUNCTION create_service_order(UUID,UUID,TEXT,TEXT,UUID,DATE,TIME,TEXT,TEXT,TEXT,TEXT,TEXT,UUID,UUID,UUID) TO authenticated;
